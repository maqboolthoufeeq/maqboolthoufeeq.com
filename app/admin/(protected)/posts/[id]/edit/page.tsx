...
export default function EditPostPage() {
  ...
  if (loading) return <div className="min-h-screen bg-[var(--background)] flex items-center justify-center text-[var(--muted)]">Loading…</div>
    ...
    <div className="min-h-screen bg-[var(--background)]">
      <header className="border-b border-[var(--border)] px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-semibold text-[var(--foreground)]">Edit Post</h1>
        </div>
        <div className="flex items-center gap-3">
